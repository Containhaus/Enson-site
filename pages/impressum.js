            ...
            <div className="row mt-3 justify-content-center">
              <div className="col-12">
                <p className="text-dark justify-text">
                  ...
                  <br/>
                  <span className="mb-3 d-flex ">E-Mail: info@containhaus.de</span> 
                  <br />
            ...
            <div className="row justify-content-center">
              <div className="text-justify col-12  m-5 ">
                ...
                <span>
                  ...
                  übertragen und dort gekürzt. Die IP-Anonymisierung ist auf
                  dieser Website aktiv. Im Auftrag des Betreibers dieser Website
                ...
                <span>
                  ...
                  zukünftig zu verhindern (das Opt Out funktioniert nur in dem
                  Browser und nur für diese Domain). Dabei wird ein
                  Opt-Out-Cookie auf Ihrem Gerät abgelegt. Löschen Sie Ihre
